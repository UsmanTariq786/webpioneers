...
const testimonials = [
  {
    ...
    quote:
      "I can highly recommend you to anyone looking for a clean, conversion-focused redesign. Great work all around. The process was smooth, and you really understood what the brand needed",
  },
  {
    id: 2,
    name: "Daniel Refn",
    ...
    quote:
      "These guys did a great job improving the layout and CRO sections of our Shopify app. The landing page design was spot on, and I’m looking forward to working with them again",
  },
  {
    id: 3,
    name: "Richard Amat",
    ...
    quote:
      "They designed the Vividora AI project from scratch, including the 3D editor and layout improvements. Super easy to work with and great at collaboration throughout",
  },
  {
    id: 4,
    name: "Cristofer",
    ...
    quote:
      "After trying multiple designers, these guys finally nailed it. They redesigned my product visuals with a clean, Apple-like feel and I’m excited to work with them on my next store",
  },
  {
    id: 5,
    ...
    quote:
      "They helped design my landing page for a new product launch and really understood the requirements. The process was smooth from start to finish and highly recommended",
  },
  {
    id: 6,
    name: "Evan Bryce",
    ...
    quote:
      "Approached them through a friend’s referral and the design turned out great. They improved both our admin portal and mobile app and I’m glad I found them.",
  },
  {
    id: 7,
    name: "Jai Howitt",
    ...
    quote:
      "We needed a clear design direction for our Art of Mondays app and they handled it perfectly. Looking forward to more opportunities together",
  },
];
...
const Testimonials = () => {
  ...
  const goToIndex = (index: number) => {
    if (sliderRef.current) {
      ...
      else if (index === testimonials.length - 1 && activeIndex === 0)
        dir = "left";
