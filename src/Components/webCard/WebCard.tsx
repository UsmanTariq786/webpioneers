...
const WebCard = ({title , image , description}: cardProps) => {
  ...
  return (
      <div className="w-full xl:w-[300px] self-center px-4 mt-4">
              <div className="flex items-center">
                <img src={image} alt="rings" width={70} height={70} />
              </div>

              <p className="text-[36px] leading-[46px] md:text-[40px] md:leading-[46px] font-normal font-['Rubik'] tracking-[-0.02em]
              ...
              <p className="w-full xl:w-[292px] min-h-[72px] opacity-80 text-[rgba(248,248,248,0.5)]
                font-['Rubik'] font-normal text-[18px] leading-[29px] md:text-[16px] md:leading-[24px] mt-[10px]">
              {description}             
              </p>
            </div>
  )
