...
const WebCard = ({title , image , description}: cardProps) => {
  ...
  return (
      <div className="w-full xl:w-[300px] self-center px-4 mt-4">
              ...
              <p className="text-[24px] leading-[42px] md:text-[36px] md:leading-[42px] font-normal font-['Rubik'] tracking-[-0.02em]
              ...
              <p className="w-full xl:w-[292px] min-h-[72px] opacity-80 text-[rgba(248,248,248,0.5)]
                font-['Rubik'] font-normal text-[16px] leading-[29px] md:text-[18px] md:leading-[24px] mt-[10px]">
              {description}             
              </p>
            </div>
  )
