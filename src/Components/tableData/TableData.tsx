            ...
            <div>
              ...
              <RoundCornerWrapper top={false}>
                <div className="flex flex-col items-center justify-center px-[20px] md:px-0 py-10 pt-20">
                  ...
                  />
                 <h1
                    className="text-[28px] md:text-[32px] lg:text-[42px] leading-[36px] md:leading-[40px] lg:leading-[56px] bg-[linear-gradient(92.95deg,rgba(248,248,248,0.9)_0%,rgba(248,248,248,0.5)_100%)] text-transparent bg-clip-text pb-1"
                    style={{
