  ...
  <section className="mt-12 ">
    ...
    <div className="flex flex-col items-center mb-10">
     <CommonQuestion question='HOW IT WORKS'/>
      <p className="w-[90%] text-[28px] leading-[36px] md:text-[32px] lg:text-[42px] md:leading-[46px] lg:leading-[56px] pt-[10px] font-normal font-['Rubik'] text-center tracking-[-0.02em]
