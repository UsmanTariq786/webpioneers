        ...
        <div className=" w-full ">
          {
            <RoundCornerWrapper bottom={false}>
              ...
              <CommonQuestion question='OUR VIBE' />
                ...
                <br />
                <h1 className="text-[32px] leading-[40px] md:text-[32px] lg:text-[42px] md:leading-[46px] lg:leading-[56px] mt-2">We help brands grow by designing smooth,smart experiences people actually enjoy using.</h1> <br />
